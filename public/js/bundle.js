...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoia2FwcG93IiwiYSI6ImNrYWswaWM2ZDBqb2oyeHA0c2s2dnprdmYifQ.k2RjEOFwu7J9mbcdh2geQA";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/kappow/ckak0u1is2cew1jp6gh3c9zlf" //   center: [-118.0, 34.0],
    //   zoom: 8,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); // Extend the map bounds to include the current location
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_YAcbRpacm352P0PpQYFJIMvf00hsGEZGaT");
            _context.prev = 1;
            _context.next = 4;
